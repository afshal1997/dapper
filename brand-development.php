...
<main>
    <section class="brandDevelopmentMainBanner" id="brandDevelopmentMainBanner">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mt-5" data-aos="fade-up">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active text-light"><b>Brand Development</b></li>
                        </ol>
                    </nav>
